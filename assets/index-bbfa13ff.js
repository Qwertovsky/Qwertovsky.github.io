...
async function renderDOMHead(head, options = {}) {
  ...
  const markEl = (ctx2) => {
    ...
    markSideEffect(ctx2, "el", () => {
      var _a3;
      (_a3 = ctx2.$el) == null ? void 0 : _a3.remove();
  ...
  for (const t of await head.resolveTags()) {
    ...
    if (!ctx2.$el && tag._hash) {
      ctx2.$el = dom.querySelector(`${((_a2 = tag.tagPosition) == null ? void 0 : _a2.startsWith("body")) ? "body" : "head"} > ${tag.tag}[data-h-${tag._hash}]`);
    }
    if (ctx2.$el) {
      if (ctx2.tag._d)
        setAttrs(ctx2);
  ...
  Object.entries(pendingRenders).forEach(([pos, queue2]) => {
    ...
    for (const $el of [...dom[pos].children].reverse()) {
      ...
      const matchIdx = queue2.findIndex((ctx2) => ctx2 && (ctx2.tag._d === dedupeKey || $el.isEqualNode(ctx2.$el)));
      if (matchIdx !== -1) {
        const ctx2 = queue2[matchIdx];
        ctx2.$el = $el;
        setAttrs(ctx2);
        markEl(ctx2);
  ...
  return defineHeadPlugin({
    hooks: {
      "tag:normalise": (ctx) => {
        ...
        if (IsBrowser$1 || ((_b = (_a2 = getActiveHead()) == null ? void 0 : _a2.resolvedOptions) == null ? void 0 : _b.document))
          return;
...
const routes = [
  {
    path: "/",
    component: () => __vitePreload(() => import("./MainPage-5585d1cc.js"), true ? ["assets/MainPage-5585d1cc.js","assets/largeqwerto-4298bb8a.js"] : void 0),
    meta: {
      title: "Valery Qwertovsky | Full-Stack Java Software Engineer",
      description: "My personal page. Find there my resume, my works, my experience, my contacts",
      keywords: "Qwertovsky, CV, resume, portfolio, developer, engineer"
    }
  },
  {
    path: "/resume",
    component: () => __vitePreload(() => import("./ResumePage-625f2c15.js"), true ? ["assets/ResumePage-625f2c15.js","assets/pdf-file-2f1ba593.js"] : void 0),
    meta: {
      title: "Qwertovsky | Resume",
      description: "Full-Stack Java Software Engineer Resume. My experience. My skills. Technologies and tools I use.",
      keywords: "Qwertovsky, CV, resume, developer, engineer"
    }
  },
  {
    path: "/resume_ru",
    component: () => __vitePreload(() => import("./ResumeRuPage-4cd7fd12.js"), true ? ["assets/ResumeRuPage-4cd7fd12.js","assets/pdf-file-2f1ba593.js"] : void 0),
    meta: {
      title: "Qwertovsky | Резюме",
      description: "Резюме Full-Stack Java программиста. Опыт. Навыки. Инструменты.",
      keywords: "Qwertovsky, CV, резюме, программист"
    }
  },
  {
    path: "/portfolio",
    component: () => __vitePreload(() => import("./PortfolioPage-2582cac3.js"), true ? [] : void 0),
    meta: {
      title: "Qwertovsky | Portfolio",
      description: "My past and current projects. Links to source code.",
      keywords: "qwertovsky, portfolio, projects"
    }
  }
];
const createHead = () => {
...
export {
  ...
  Fragment as N,
  renderList as O,
  Vue2ProvideUnheadPlugin as V,
  _export_sfc as _,
  isHTMLTag as a,
  isSVGTag as b,
  isString as c,
  createRenderer as d,
  createHydrationRenderer as e,
  extend as f,
  isOn as g,
  isModelListener as h,
  isFunction as i,
  isArray$1 as j,
  hyphenate as k,
  camelize as l,
  ...
  includeBooleanAttr as o,
  callWithAsyncErrorHandling as p,
  createHead$2 as q,
